...
We investigate how divalent ions (Mg²⁺, Zn²⁺, Ca²⁺) interact with electrochemical interfaces at the molecular level. By understanding and manipulating the ion's solvation structure, we control whether it crosses an interface, what it forms when it arrives, and whether a desired reaction proceeds selectively in different electrochemical applications like battereies, electrochemical reduction and selective ion separation.
